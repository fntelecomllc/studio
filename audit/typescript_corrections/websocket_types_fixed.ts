...
import { UUID, ISODateString, SafeBigInt, createSafeBigInt } from '../../src/lib/types/branded';
      ...
      case WebSocketMessageTypes.CAMPAIGN_PROGRESS: {
        ...
        return {
          ...
          data: {
            ...
            totalItems: createSafeBigInt(data.totalItems),
            processedItems: createSafeBigInt(data.processedItems),
            successfulItems: createSafeBigInt(data.successfulItems),
            failedItems: createSafeBigInt(data.failedItems),
      ...
      case WebSocketMessageTypes.DOMAIN_GENERATED: {
        ...
        return {
          ...
          data: {
            ...
            domain: data.domain,
            offset: createSafeBigInt(data.offset),
            batchSize: data.batchSize,
            totalGenerated: createSafeBigInt(data.totalGenerated)
          }
      ...
      case WebSocketMessageTypes.DNS_VALIDATION_RESULT: {
        ...
        return {
          ...
          data: {
            ...
            totalValidated: createSafeBigInt(data.totalValidated)
          }
