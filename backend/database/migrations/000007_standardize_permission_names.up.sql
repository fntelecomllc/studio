-- Migration to standardize permission names from dot notation to colon notation
-- This ensures compatibility with frontend expectations and future deployments

-- Update permission names from dot notation to colon notation if they exist
-- Using conditional updates to ensure this migration is idempotent
